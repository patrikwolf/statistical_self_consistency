...
from prompting.assemble_sc_prompts import assemble_wvs_prior_distribution_prompt, assemble_tennis_prompt
...
def get_llm_estimated_prior_distribution(
    ...
    prompt, group_wise_attribute_lists = assemble_wvs_prior_distribution_prompt(
        ...
        template_filename="tennis_prior_distribution_estimation_v1.txt",
    )
...
def get_llm_estimated_answer_distribution(
    ...
    # Generate prompt
    prompt = assemble_tennis_prompt(attributes=combination)
