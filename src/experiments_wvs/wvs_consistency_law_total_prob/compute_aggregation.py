...
from experiments_wvs.wvs_consistency_law_total_prob.llm_estimates import load_test_llm_estimates
...
def _compute_aggregated_estimate(
    ...
    for node in attribute_nodes:
        ...
        llm_estimates = next((entry for entry in llm_estimate_dict[question_identifier]["llm_estimates"]
                              if entry["combination"] == node), None)
...
if __name__ == "__main__":
    ...
    # LLM estimates
    llm_estimate_dict = load_test_llm_estimates()
