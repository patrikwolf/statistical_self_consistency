...
from experiments_acs.consistency_lotp_thresholded_inc.helper.llm_estimates import get_all_llm_estimates
from experiments_acs.consistency_lotp_thresholded_inc.helper.evaluation import evaluate_aggregated_results, \
    evaluate_order_consistency
from experiments_acs.consistency_lotp_thresholded_inc.helper.final_scoring import compute_new_final_scores
#
...
def main(
    ...
    # Evaluate aggregated versus direct estimate (absolute difference)
...
if __name__ == "__main__":
    ...
    # Not used
    # model = "moonshotai/kimi-k2.6"        --> rate limited
    # model = "mistralai/mistral-nemo"      --> rate limited
    # model = "qwen/qwen3.6-flash"          --> rate limited (and unreliable)
    # model = "moonshotai/kimi-k2.6"        --> inference is too slow
    # model = "z-ai/glm-5.2"                --> inference is too slow
    # model = "deepseek/deepseek-v4-pro"    --> inference is too slow
    # model = "x-ai/grok-4.5"               --> inference is too slow
    # model = "qwen/qwen3-4b"               --> no endpoint found
    # model = "openai/gpt-5"
    ...
    # Config
    cfg = ModelConfig(
        experiment_name="acs_income_self_consistency",
        model_name=model,
