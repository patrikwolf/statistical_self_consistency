...
from prompting.assemble_acs_prompts import assemble_joint_prior_estimation_prompt, assemble_few_bin_commute_prompt
...
def get_llm_estimated_answer_distribution(
    ...
    # Generate prompt
    prompt, bin_details = assemble_few_bin_commute_prompt(
        bin_edges=bin_edges,
        filters=[c["value_description"] for c in combination],
        prompting_scheme="sociodemographic",
        filtered_template_filename="ACS_commute_few_bins_v1.txt",
        no_filter_template_filename="ACS_commute_few_bins_no_filters_v1.txt",
        improved_age_desc=True,
