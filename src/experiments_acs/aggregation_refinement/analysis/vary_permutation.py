...
if __name__ == "__main__":
    ...
    decomposition_attributes = {
        ...
        "level_3": standard_decomposition_attributes["level_4"],
        "level_4": standard_decomposition_attributes["level_3"],
    }
    ...
    cfg = MinimalExperimentConfig(
        ...
        model_name="openai/gpt-5.4",  # "openai/gpt-5.4", "openai/gpt-5.4", "Qwen/Qwen3-8B"
