...
def plot_aggregation_refinement(results: dict, plot_dir: Path, experiment_name: str, load_joint_llm_priors: bool):
    ...
    plt.savefig(plot_subdir / f"permutations_{experiment_name}.png", dpi=300)
    plt.savefig(plot_subdir / f"permutations_{experiment_name}.pdf")
...
if __name__ == "__main__":
    ...
    with open("experiments_refinement_permutations.yaml", "r") as f:
